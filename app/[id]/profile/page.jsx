...
// import { FaUserCircle, FaArrowRight, FaTimes, FaEnvelope, FaHome, FaUser, FaProjectDiagram, FaInbox, FaPlus, FaEdit } from 'react-icons/fa';
...
//     // Update projectsData with new freelancer info
...
//       case 'profile':
//         return (
//           <section id="profile" className="bg-white rounded-xl shadow-[0_6px_20px_rgba(0,0,0,0.08)] p-8 w-full">
//             <h2 className="font-montserrat font-bold text-3xl text-[#6a1b9a] mb-6 text-center">Your Profile</h2>
//             <div className="flex flex-col items-center md:flex-row md:items-start gap-8">
//               <img
//                 src={freelancerData.avatar}
//                 alt={freelancerData.name}
//                 className="w-32 h-32 rounded-full object-cover border-2 border-[#00bcd4] shadow-[0_2px_10px_rgba(0,0,0,0.1)]"
//               />
//               <div className="text-center md:text-left flex-grow">
//                 <h3 className="font-montserrat font-bold text-2xl text-[#6a1b9a] mb-2">{freelancerData.name}</h3>
//                 <p className="text-lg text-[#757575] mb-2">{freelancerData.profession}</p>
//                 <p className="text-base text-[#757575] mb-4">{freelancerData.bio}</p>
//                 <a
...
//       case 'projects':
//         return (
//           <section id="projects" className="bg-white rounded-xl shadow-[0_6px_20px_rgba(0,0,0,0.08)] p-8 w-full h-[80vh] overflow-y-auto">
...
//       case 'inquiries':
//         return (
//           <section id="inquiries" className="bg-white rounded-xl shadow-[0_6px_20px_rgba(0,0,0,0.08)] p-8 w-full h-[90vh]">
//             <div className="flex justify-between items-center mb-6">
...
//             </div>
//             <div className="overflow-y-auto overflow-x-hidden max-h-90vh space-y-6">
...
//               onClick={() => setActiveSection(activeSection === 'profile' ? 'projects' : 'profile')}
//             >
//               <FaUserCircle />
//             </button>
//           </nav>
...
//       {/* Main Content */}
//       <main className="py-6">
//         <div className="max-w-screen mx-auto px-6 flex flex-col lg:flex-row gap-8">
//           {/* Left Sidebar (30%) */}
//           <aside className="lg:w-[20%] bg-white rounded-xl shadow-[0_6px_20px_rgba(0,0,0,0.08)] p-6 sticky top-20 h-[calc(100vh-80px)] flex flex-col">
...
//                 className={`flex items-center gap-3 w-full text-left font-semibold text-base ${activeSection === 'profile' ? 'text-[#6a1b9a]' : 'text-[#757575]'} hover:text-[#6a1b9a] transition-colors`}
//               >
//                 <FaUser /> Profile
//               </button>
//               <button
