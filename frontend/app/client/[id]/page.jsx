...
// import { FaUserCircle, FaArrowRight, FaTimes, FaEnvelope, FaHome, FaProjectDiagram, FaInbox, FaEdit } from 'react-icons/fa';
...
//         headers: { Authorization: `Bearer ${token}` },
//         params: { other_party_type: 'freelancer' },
//       });
//       // Group messages by freelancer to get inquiries
//       const freelancers = {};
//       response.data.forEach(msg => {
//         if (msg.sender_type === 'freelancer') {
//           freelancers[msg.sender_id] = {
//             id: msg.sender_id,
//             freelancerName: `Freelancer ${msg.sender_id}`, // Placeholder
//             freelancerAvatar: `https://randomuser.me/api/portraits/men/${msg.sender_id}.jpg`, // Placeholder
//             message: msg.content,
//             timestamp: msg.timestamp,
//             portfolio: `https://freelancer${msg.sender_id}.design`, // Placeholder
//           };
//         }
//       });
...
//       // Extract projects from messages sent by the client
//       const projectMessages = response.data
//         .filter(msg => msg.sender_type === 'client' && msg.content.includes('booking your project'))
//         .map(msg => ({
//           id: msg.id.toString(),
//           title: msg.content.match(/"([^"]+)"/)?.[1] || 'Untitled Project', // Extract project title from message
//           freelancerName: `Freelancer ${msg.receiver_id}`, // Placeholder
//           freelancerBio: 'Experienced freelancer specializing in creative projects.', // Placeholder
//           freelancerAvatar: `https://randomuser.me/api/portraits/men/${msg.receiver_id}.jpg`, // Placeholder
//           price: (Math.floor(Math.random() * 1000) + 500).toString(), // Mock price
//           image: `https://source.unsplash.com/random/800x600/?project,design${msg.id}`, // Mock image
//           description: 'Project booked via message.', // Placeholder
//           designHighlights: ['Custom design', 'Responsive layout'], // Placeholder
//           technologies: ['Figma', 'React'], // Placeholder
//         }));
...
//           {
//             receiver_id: parseInt(project.id), // Assuming project.id is the freelancer_id
...
//         );
//         alert(`Success! Your booking request for "${project.title}" has been sent to ${project.freelancerName}.`);
//         fetchMessages(); // Refresh projects and inquiries
//         closeModal();
//       } catch (err) {
...
//     e.preventDefault();
//     if (!editProfile.name || !editProfile.company || !editProfile.bio || !editProfile.website) {
//       setError('Please fill in all fields.');
//       return;
//     }
//     try {
//       const token = localStorage.getItem('token');
//       await axios.put('http://localhost:8000/clients/me', editProfile, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       alert('Profile updated successfully!');
//       fetchClientData();
...
//                 ))
//               ) : (
//                 <p className="text-center text-[#757575] text-lg">No projects contacted yet. Explore the discover page to find projects!</p>
//               )}
//             </div>
//           </section>
//         );
...
//             <div className="flex flex-col items-center text-center mb-8">
//               <img
//                 src="https://randomuser.me/api/portraits/men/50.jpg" // Placeholder
//                 alt={clientData.name}
//                 className="w-24 h-24 rounded-full object-cover border-2 border-[#00bcd4] shadow-[0_2px_10px_rgba(0,0,0,0.1)] mb-4"
//               />
//               <h2 className="font-montserrat font-bold text-2xl text-[#6a1b9a] mb-2">{clientData.name}</h2>
...
//         .map(msg => ({
//           id: msg.id.toString(),
//           title: msg.content.match(/"([^"]+)"/)?.[1] || 'Untitled Project', // Extract project title
//           freelancerName: `Freelancer ${msg.receiver_id}`, // Placeholder
//           freelancerBio: 'Experienced freelancer specializing in creative projects.', // Placeholder
//           freelancerAvatar: `https://randomuser.me/api/portraits/men/${msg.receiver_id}.jpg`, // Placeholder
//           price: (Math.floor(Math.random() * 1000) + 500).toString(), // Mock price
